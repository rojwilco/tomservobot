...
# from https://gist.github.com/jmingtan/1171288/8286cd988b90f0df41b5ed8d8cfc4a185ce95504
...
if len(sys.argv) <= 1:
    print(
    """
    Autoreload - Restarts a process upon file changes.
    Usage:
      %s [-f filter] command" % sys.argv[0]

      -f filter    optional file extension (e.g. *.py)
